...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetButton m_bouton_edition;        // Sera le bouton avec le texte EDITION
        grman::WidgetText m_bouton_edition_label;    // Le texte EDITION
        grman::WidgetButton m_bouton_new;       // Sera le bouton avec le texte NEW
        grman::WidgetText m_bouton_new_label;   // Le texte NEW
        grman::WidgetButton m_bouton_delete;       // Sera le bouton avec le texte DELETE
        grman::WidgetText m_bouton_delete_label;   // Le texte DELETE
        grman::WidgetButton m_bouton_save;       // Sera le bouton avec le texte SAVE
        grman::WidgetText m_bouton_save_label;   // Le texte SAVE
        grman::WidgetButton m_bouton_exit;       // Sera le bouton avec le texte EXIT
        grman::WidgetText m_bouton_exit_label;   // Le texte EXIT
    ...
    public :
        ...
        grman::WidgetButton& getBoutonSave();
        grman::WidgetButton& getBoutonExit();
...
class Graph
{
    ...
    public:
        ...
        void add_interfaced_vertex(int idx, double value, int x, int y, std::string pic_name="", double range =0, int pic_idx=0 );
